...
a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"다음",sPrevious:"이전"},sEmptyTable:"No data available in table",sInfo:"총 _TOTAL_개 항목",sInfoEmpty:"총 0개 항목",
sInfoFiltered:"(총 _MAX_ 개 항목중)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"페이지당 항목수 _MENU_  ",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"검색:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},oSearch:h.extend({},l.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
